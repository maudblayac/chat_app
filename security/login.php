...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Requête SQL pour sélectionner l'utilisateur correspondant au pseudo et mot de passe fourni
    $stmt = $pdo->prepare("SELECT id FROM users WHERE pseudo = :pseudo AND mdp = :mdp");
